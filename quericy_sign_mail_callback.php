...
function callback_init()
{
    ...
    option::add('quericy_sign_mail_content', '<h4 style="text-align:center;">贴吧云签到报告</h4><div class="wrapper"><table class="result_table"><thead><tr><td style="width: 60px">项目</td><td style="width: 150px">内容</td><td style="width: 75px">备注</td></tr></thead><tbody><tr><td>签到日期</td><td><a href="[date]" target="_blank">[date]</a></td><td>当日报告已生成</td></tr><tr><td>用户名称</td><td><a href="[date]" target="_blank">[name]</a></td><td>您是该站云签用户</td></tr><tr><td>报告地址</td><td><a href="[link]" target="_blank">[link]</a></td><td>点击链接直达,次日失效</td></tr><tr><td>云签站点</td><td><a href="[SYSTEM_URL]" target="_blank">[SYSTEM_NAME]</a></td><td>如有疑问,进站反馈</td></tr></tbody></table><br><p style="font-size: 12px; color: #9f9f9f; text-align: right; border-top: 1px solid #dedede; padding: 20px 10px 0; margin-top: 25px;">发自[SYSTEM_NAME]<br>百度贴吧云签到作者:<a href="http://zhizhe8.net/"> Kenvix</a>&<a href="http://www.longtings.com/">mokeyjay</a>&<a href="http://fyy.l19l.com/">FYY</a><br>邮件扩展作者:<a href="https://quericy.me">quericy</a></p>
</div><style type="text/css">div.wrapper * { font: 12px "Microsoft YaHei", arial, helvetica, sans-serif; word-break: break-all; }div.wrapper a { color: #15c; text-decoration: none; }div.wrapper a:active { color: #d14836; }div.wrapper a:hover { text-decoration: underline; }div.wrapper p { line-height: 20px; margin: 0 0 .5em; text-align: center; }div.wrapper .sign_title { font-size: 20px; line-height: 24px; }div.wrapper .result_table { width: 85%; margin: 0 auto; border-spacing: 0; border-collapse: collapse; }div.wrapper .result_table td { padding: 10px 5px; text-align: center; border: 1px solid #dedede; }div.wrapper .result_table tr { background: #d5d5d5; }div.wrapper .result_table tbody tr { background: #efefef; }div.wrapper .result_table tbody tr:nth-child(odd) { background: #fafafa; }</style>');
    //cron_tab setting
